...
<section id="about" class="paddingSection">
    <div class="container">
        ...
        <div class="avatar-portrait"><canvas id="avatar-anim" width="450" height="486" style="background-color:rgba(0,0,0,0);"></canvas></div>
        <!-- Section Text one -->
...
<section id="work" class="paddingstandardTop">
    ...
    <div id="portfoliogrid">
        ...
        <div class="item ui">
            ...
            <img src="$ThemeDir/img/work/work-edwingolf-1.jpg" alt="Portfolio" />
        </div>
...
<section id="spacesuit">
    <div class="spacesuit-bg">
